...
//                firstChild.transform.position = new Vector3(lastChild.transform.position.y + halfobjectHeight * 2, lastChild.transform.position.x, lastChild.transform.position.z);
///            }
//            else if(transform.position.y - screenBounds.y < firstChild.transform.position.y - halfobjectHeight)
//            {
//                lastChild.transform.SetAsFirstSibling();
//                lastChild.transform.position = new Vector3(firstChild.transform.position.y - halfobjectHeight * 2, firstChild.transform.position.x, firstChild.transform.position.z);
//            }
//        }
//    }
//    void Update() 
